{
  ...
  cfg = config.addons.utils.snacks;
in {
  options.addons.utils.snacks.enable = lib.mkEnableOption "Enable snacks module";
  ...
  config = lib.mkIf cfg.enable {
    ...
    wKeyList = lib.mkIf config.addons.ui.which-key.enable [(specObj ["<leader>u" "󰔎" "ui"])];
  };
}
