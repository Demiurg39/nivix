{
  ...
  cfg = config.addons.ui.lualine;
in {
  options.addons.ui.lualine.enable = lib.mkEnableOption "Enable lualine module";

  config = lib.mkIf cfg.enable {
    # TODO: substitute lualine and bufline with heirline
    plugins.lualine = {
      enable = true;
      settings.options = {
        theme = let
